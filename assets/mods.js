const recentlyAddedMods = [
    ...
    { name: 'Jadehoof', category: 'couriers' },
    { name: 'Golden Flopjaw the Boxhound', category: 'couriers' },
    { name: 'Golden Huntling', category: 'couriers' },
    { name: 'Golden Venoling', category: 'couriers' },
    { name: 'Golden Seekling', category: 'couriers' },
    { name: 'Golden Doomling', category: 'couriers' },
    { name: 'Desert Sands Baby Roshan', category: 'couriers' },
    { name: 'Baby Roshan 2017', category: 'couriers' },
    ...
    { name: 'Bane Komeiji Koishi', category: 'heroes' },
    { name: 'Outworld Destroyer Yukari', category: 'heroes' },
    { name: 'Phantom Assassin Rory', category: 'heroes' },
    { name: 'Lich Miyuki Shiba', category: 'heroes' },
    { name: 'Legion Commander Nero', category: 'heroes' },
    { name: 'Night Stalker Remilia', category: 'heroes' },
    { name: 'Death Prophet Yuyuko', category: 'heroes' },
    { name: 'Ember Spirit Shana', category: 'heroes' },
    { name: 'Gyrocopter Kongou', category: 'heroes' },
    { name: 'Abaddon Sayaka Miki', category: 'heroes' },
    { name: 'Troll Warlord Reimu', category: 'heroes' },
    { name: 'Weaver Kurumi', category: 'heroes' },
    { name: 'Tinker Sakuya', category: 'heroes' },
    { name: 'Wave Lite White', category: 'shaders' },
    { name: 'Wave Lite Aqua', category: 'shaders' },
...
const modsData = {
    'shaders': [
        ...
        { name: 'Haze', preview: 'haze_shader.webp', file: 'pak11_dir.vpk', linkType: 'source', linkUrl: 'https://dota2changer.com/skins_dota_2_mods-haze_shader/' },
        { name: 'Ancient', preview: 'ancient_shader.webp', file: 'pak10_dir.vpk', linkType: 'source', linkUrl: 'https://dota2changer.com/skins_dota_2_mods-ancient_shader/' },
        { name: 'Purple Ancient', preview: 'purple_ancient_shader.webp', file: 'pak12_dir.vpk' },
