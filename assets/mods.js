const recentlyAddedMods = [
    ...
    { name: 'Meepo Diretide', category: 'heroes' },
    ...
    { name: 'Ogre Magi Amakusa Shiro', category: 'heroes' },
    { name: 'Mirana Suigintou', category: 'heroes' },
    { name: 'Natures Prophet Say', category: 'heroes' },
    { name: 'Night Stalker Remilia', category: 'heroes' },
    { name: 'Keeper of the Light Renegade', category: 'heroes' },
    { name: 'Brewmaster Military Saint', category: 'heroes' },
    { name: 'Phite Phantom Assassin', category: 'heroes' },
    { name: 'Legion Commander Persona', category: 'heroes' },
...
const modsData = {
    'heroes': [
        ...
        { name: 'Alien Nyx Assassin', preview: 'Alien Nyx Assassin.webp', file: 'Alien Nyx Assassin.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-alien_nyx_assassin_megapack/' }] },
        ...
        { name: 'Ashes Arc Warden', preview: 'Ashes Arc Warden.webp', file: 'Ashes Arc Warden.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        ...
        { name: 'Brewmaster Jousting Panda', preview: 'Brewmaster Jousting Panda.webp', file: 'Brewmaster Jousting Panda.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-brew_jousting_panda_and_donkey_kong/' }] },
        { name: 'Broodmother Redan', preview: 'Broodmother Redan.webp', file: 'Broodmother Redan.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-broodmother_redan_megapack/' }] },
        { name: 'Clinkz Silver Metall Pink', preview: 'Clinkz Silver Metall Pink.webp', file: 'Clinkz Silver Metall Pink.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-silver_metall_clinkz_pink_megapack/' }] },
        { name: 'Darkness Weaver', preview: 'Darkness Weaver.webp', file: 'Darkness Weaver.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-darkness_weaver_modpack/' }] },
        { name: 'Drow Ranger Stranger Arcana', preview: 'Drow Ranger Stranger Arcana.webp', file: 'Drow Ranger Stranger Arcana.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-stranger_in_the_wandering_isles/' }] },
        { name: 'Earthshaker Red Arcana', preview: 'Earthshaker Red Arcana.webp', file: 'Earthshaker Red Arcana.zip', tags: { effects: false, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-earthshaker_red_arcana/' }] },
        { name: 'Ghost Shadow Fiend', preview: 'Ghost Fiend.webp', file: 'Ghost Fiend.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-ghost_fiend/' }] },
        { name: 'Ghosty Slark', preview: 'Ghosty Slark.webp', file: 'Ghosty Slark.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-ghosty_slark_megapack/' }] },
        { name: 'Gopo Pudge', preview: 'GopoPudge.webp', file: 'GopoPudge.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-gopopudge/' }] },
        { name: 'Gopo Tidehunter', preview: 'GopoTide.webp', file: 'GopoTide.zip', tags: { effects: false, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-gopotide/' }] },
        { name: 'Ice Phoenix', preview: 'Ice Phoenix.webp', file: 'Ice Phoenix.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-ice_phoenix_v_2_0/' }] },
        { name: 'Ice Venomancer', preview: 'Ice Venomancer.webp', file: 'Ice Venomancer.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-custom_ice_venomancer_megapack/' }] },
        { name: 'IO Pink Arcana', preview: 'IO Pink Arcana.webp', file: 'IO Pink Arcana.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-custom_wisp_arcana_by_defiree/' }] },
        { name: 'Kai Meepo', preview: 'Kai Meepo.webp', file: 'Kai Meepo.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-kai_meepo/' }] },
        { name: 'Legion Commander Crimson Black', preview: 'Legion Commander Crimson Black.webp', file: 'Legion Commander Crimson Black.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-legion_commander_custom_arcana_crimson_black_defireee/' }] },
        { name: 'Morphling Darktrench Purple', preview: 'Morphling Darktrench Stalker Purple.webp', file: 'Morphling Darktrench Stalker Purple.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://vk.com/wall-127340251_11856' }] },
        { name: 'Nightmare Chaos Knight', preview: 'Nightmare Chaos Knight.webp', file: 'Nightmare Chaos Knight.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-nightmare_chaos_knight_megapack/' }] },
        { name: 'Ogre Magi Custom Arcana', preview: 'Ogre Magi Custom Arcana.webp', file: 'Ogre Magi Custom Arcana.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-custom_arcana_ogre_magi_by_defiree/' }] },
        { name: 'Old Storm Spirit', preview: 'Old Storm Spirit.webp', file: 'Old Storm Spirit.zip', tags: { effects: true, icons: true } },
        { name: 'Pudge Arcana Elephant', preview: 'Pudge Arcana Elephant.webp', file: 'Pudge Arcana Elephant.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-custom_pudge_arcana_elephant/' }] },
        { name: 'Pudge CM', preview: 'Pudge CM.webp', file: 'Pudge CM.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-pudge-cm/' }] },
        { name: 'Queen of Pain Rose', preview: 'Queen of Pain Rose.webp', file: 'Queen of Pain Rose.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-pink_rose_custom_arcana_queen_of_pain/' }] },
        { name: 'Russian Ursa', preview: 'Russian Ursa.webp', file: 'Russian Ursa.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-russian_ursa-bear/' }] },
        { name: 'Scarlet Keeper', preview: 'Scarlet Keeper.webp', file: 'Scarlet Keeper.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-darkness_scarlet_keeper/' }] },
        { name: 'Shadow Fiend White', preview: 'Shadow Fiend White.webp', file: 'Shadow Fiend White.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/hero-tag:shadow%20fiend-list_skins_dlya_dota_2-0/#megapack' }] },
        { name: 'Spectre Toxin', preview: 'Spectre Toxin.webp', file: 'Spectre Toxin.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-darkness_toxin_spectre/' }] },
        { name: 'Spirit Breaker Ghost Monster', preview: 'Spirit Breaker Ghost Monster.webp', file: 'Spirit Breaker Ghost Monster.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-custom_spirit_breaker_ghost_monster/' }] },
        { name: 'Steel Sand King', preview: 'Steel King.webp', file: 'Steel King.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-steel_king/' }] },
        // { name: 'The Mawsworn Razor', preview: 'The Mawsworn Razor.webp', file: 'The Mawsworn Razor.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-the_mawsworn_razor/' }] }, hodit zadom v katke suka takaya
        { name: 'Ursa White and Red', preview: 'Ursa White and Red.webp', file: 'Ursa White and Red.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-ursa_sss_rank_or_white_and_red_megapack/' }] },
        { name: 'Winter Ember Spirit', preview: 'Winter Ember Spirit.webp', file: 'Winter Ember Spirit.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-winter_ember_spirit/' }] },
        { name: 'Night Ursa', preview: 'Night Ursa.webp', file: 'Night Ursa.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-night_ursa_megapack/' }] },
        { name: 'Flameling Morphling', preview: 'Flameling Morphling.webp', file: 'Flameling Morphling.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-flameling_morphling_megapack/' }] },
        { name: 'Ghost Void Spirit', preview: 'Ghost Void Spirit.webp', file: 'Ghost Void Spirit.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-ghost_void_spirit/' }] },
        { name: 'Anti-Mage Shadow Slayer', preview: 'Anti-Mage Shadow Slayer.webp', file: 'Anti-Mage Shadow Slayer.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-shadow_slayer/' }] },
        { name: 'Dawnbreaker Death Knight', preview: 'Dawnbreaker Death Knight.webp', file: 'Dawnbreaker Death Knight.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-death_knight/' }] },
        { name: 'Bloody Death Prophet', preview: 'Bloody Death Prophet.webp', file: 'Bloody Death Prophet.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-death_prophet_custom_modpack/' }] },
        { name: 'Blue Soul Huskar', preview: 'Blue Soul Huskar.webp', file: 'Blue Soul Huskar.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-blue_soul_huskar_megapack/' }] },
        { name: 'Red Abaddon', preview: 'Red Abaddon.webp', file: 'Red Abaddon.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-abaddon_red_megapack/' }] },
        { name: 'Void Morphling', preview: 'Void Morphling.webp', file: 'Void Morphling.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-void_morphling_by_darknessing/' }] },
        { name: 'Terrorblade Wrong Arcana', preview: 'Terrorblade Wrong Arcana.webp', file: 'Terrorblade Wrong Arcana.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/hero-tag:terrorblade-list_skins_dlya_dota_2-0/' }] },
        { name: 'Jakiro Himera', preview: 'Jakiro Himera.webp', file: 'Jakiro Himera.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-jakiro_himera/' }] },
        { name: 'Cosmic Enigma', preview: 'Cosmic Enigma.webp', file: 'Cosmic Enigma.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-graviton_blackguard/' }] },
        { name: 'Medusa Gorgon', preview: 'Medusa Gorgon.webp', file: 'Medusa Gorgon.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-medusa_gorgon/' }] },
        { name: 'Ifrit Monkey King', preview: 'Ifrit Monkey King.webp', file: 'Ifrit Monkey King.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-ifrit_monkey_king/' }] },
        { name: 'Morphling Darktrench Tears', preview: 'Morphling Darktrench Tears.webp', file: 'Morphling Darktrench Tears.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-darktrench_stalker_and_blade_of_tears/' }] },
        { name: 'Sven Blue Angel', preview: 'Sven Blue Angel.webp', file: 'Sven Blue Angel.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-blue_angel_of_sven/' }] },
        { name: 'Pinkie Sven', preview: 'Pinkie Sven.webp', file: 'Pinkie Sven.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-pinkie_sven/' }] },
        { name: 'Sherman Crystal Maiden', preview: 'Sherman Crystal Maiden.webp', file: 'Sherman Crystal Maiden.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-sherman_maiden_v_4_1/' }] },
        { name: 'Sakura Pink Invoker', preview: 'Sakura Pink Invoker.webp', file: 'Sakura Pink Invoker.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Razor Rainbow Statics', preview: 'Razor Rainbow Statics.webp', file: 'Razor Rainbow Statics.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Amir4an' }] },
        { name: 'Maid Marci', preview: 'Maid Marci.webp', file: 'Maid Marci.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kliromin' }] },
        { name: 'Terrorblade Unblinking Horror', preview: 'Terrorblade Unblinking Horror.webp', file: 'Terrorblade Unblinking Horror.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        // { name: 'Purple Shadow Fiend', preview: 'Purple Shadow Fiend.webp', file: 'Purple Shadow Fiend.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] }, dead after 7.40
        { name: 'Cursed Shadow Fiend', preview: 'Cursed Shadow Fiend.webp', file: 'Cursed Shadow Fiend.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Juggernaut Ice and Fire', preview: 'Juggernaut Ice and Fire.webp', file: 'Juggernaut Ice and Fire.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Kisilev' }] },
        ...
        { name: 'Batrider Night Snotty', preview: 'Batrider Night Snotty.webp', file: 'Batrider Night Snotty.zip', tags: { effects: true, icons: false }, links: [{ type: 'sender', url: 'lebensinhalt' }, { type: 'source', url: 'https://dota2changer.com' }] },
        { name: 'Morphling Megalodon', preview: 'Morphling Megalodon.webp', file: 'Morphling Megalodon.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Primal Beast Snowbeast', preview: 'Primal Beast Snowbeast.webp', file: 'Primal Beast Snowbeast.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        ...
        { name: 'Emerald Shadow Fiend', preview: 'Emerald Shadow Fiend.webp', file: 'Emerald Shadow Fiend.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Skratch' }] },
        ...
        { name: 'Phantom Assassin Skull Arcana', preview: 'Phantom Assassin Skull Arcana.webp', file: 'Phantom Assassin Skull Arcana.zip', tags: { effects: true, icons: false }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Spectre Phantom Advent', preview: 'Spectre Phantom Advent.webp', file: 'Spectre Phantom Advent.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Invoker Bloody Wizard', preview: 'Invoker Bloody Wizard.webp', file: 'Invoker Bloody Wizard.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        ...
        { name: 'Cursed Queen of Pain', preview: 'Cursed Queen of Pain.webp', file: 'Cursed Queen of Pain.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Legion Commander Holy Paladin', preview: 'Legion Commander Holy Paladin.webp', file: 'Legion Commander Holy Paladin.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        ...
        { name: 'Purple Witch Broodmother', preview: 'Purple Witch Broodmother.webp', file: 'Purple Witch Broodmother.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Blue Dragon Puck', preview: 'Blue Dragon Puck.webp', file: 'Blue Dragon Puck.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        ...
        { name: 'Pudge Clown Toy', preview: 'Pudge Clown Toy.webp', file: 'Pudge Clown Toy.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'ToxicPunk Timbersaw', preview: 'ToxicPunk Timbersaw.webp', file: 'ToxicPunk Timbersaw.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Shadow Timbersaw', preview: 'Shadow Timbersaw.webp', file: 'Shadow Timbersaw.zip', tags: { effects: true, icons: true }},
        { name: 'Anti-Mage Illidan v2', preview: 'Anti-Mage Illidan v2.webp', file: 'Anti-Mage Illidan v2.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Ember Spirit Green Samurai', preview: 'Ember Spirit Green Samurai.webp', file: 'Ember Spirit Green Samurai.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Wraith King Pizdec', preview: 'Wraith King Pizdec.webp', file: 'Wraith King Pizdec.zip', tags: { effects: false, icons: false }},
        { name: 'Young Invoker Dark Artistry', preview: 'Young Invoker Dark Artistry.webp', file: 'Young Invoker Dark Artistry.zip', tags: { effects: false, icons: true }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Crystal Maiden Tamamo no Mae', preview: 'Crystal Maiden Tamamo no Mae.webp', file: 'Crystal Maiden Tamamo no Mae.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Devil Legion Commander', preview: 'Devil Legion Commander.webp', file: 'Devil Legion Commander.zip', tags: { effects: true, icons: false }, links: [{ type: 'author', url: 'Skratch' }] },
        { name: 'Pudge Toy Butcher', preview: 'Pudge Toy Butcher.webp', file: 'Pudge Toy Butcher.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Axe Unleashed', preview: 'Axe Unleashed.webp', file: 'Axe Unleashed.zip', tags: { effects: true, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        ...
        { name: 'Snowing Marci', preview: 'Snowing Marci.webp', file: 'Snowing Marci.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Phantom Assassin Persona', preview: 'Phantom Assassin Persona.webp', file: 'Phantom Assassin Persona.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Anti-Mage Turstarkuri Pilgrim', preview: 'Anti-Mage Turstarkuri Pilgrim.webp', file: 'Anti-Mage Turstarkuri Pilgrim.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Viper Stuffed Menace', preview: 'Viper Stuffed Menace.webp', file: 'Viper Stuffed Menace.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Enigma Angel of the Abyss', preview: 'Enigma Angel of the Abyss.webp', file: 'Enigma Angel of the Abyss.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        ...
        { name: 'Primal Beast Dark Behemoth', preview: 'Primal Beast Dark Behemoth.webp', file: 'Primal Beast Dark Behemoth.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Arc Warden Yin Yang', preview: 'Arc Warden Yin Yang.webp', file: 'Arc Warden Yin Yang.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        ...
        { name: 'Black Witch Doctor', preview: 'Black Witch Doctor.webp', file: 'Black Witch Doctor.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Ice Chaos Knight', preview: 'Ice Chaos Knight.webp', file: 'Ice Chaos Knight.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        ...
        { name: 'Pink Nyx Assassin', preview: 'Pink Nyx Assassin.webp', file: 'Pink Nyx Assassin.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        ...
        { name: 'Tidehunter Insatiable Seas', preview: 'Tidehunter Insatiable Seas.webp', file: 'Tidehunter Insatiable Seas.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Morphling Fluid Frenzy', preview: 'Morphling Fluid Frenzy.webp', file: 'Morphling Fluid Frenzy.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Techies Arab', preview: 'Techies Arab.webp', file: 'Techies Arab.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'laskotdota' }] },
        { name: 'Wraith King Itsuka Kotori', preview: 'Wraith King Itsuka Kotori.webp', file: 'Wraith King Itsuka Kotori.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Sven Yatogami Tohka', preview: 'Sven Yatogami Tohka.webp', file: 'Sven Yatogami Tohka.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Sven Yatogami Tohka v2', preview: 'Sven Yatogami Tohka v2.webp', file: 'Sven Yatogami Tohka v2.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Crystal Maiden Cirno', preview: 'Crystal Maiden Cirno.webp', file: 'Crystal Maiden Cirno.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Bane Komeiji Koishi', preview: 'Bane Komeiji Koishi.webp', file: 'Bane Komeiji Koishi.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Outworld Destroyer Yukari', preview: 'Outworld Destroyer Yukari Yakumo.webp', file: 'Outworld Destroyer Yukari Yakumo.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Phantom Assassin Rory', preview: 'Phantom Assassin Rory Mercury.webp', file: 'Phantom Assassin Rory Mercury.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Lich Miyuki Shiba', preview: 'Lich Miyuki Shiba.webp', file: 'Lich Miyuki Shiba.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Legion Commander Nero', preview: 'Legion Commander Nero.webp', file: 'Legion Commander Nero.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        {
            name: 'Night Stalker Remilia',
            styles: [
                { label: 'Style I', color: '#ddd4ff', preview: 'Night Stalker Remilia.webp', file: 'Night Stalker Remilia.zip' },
                { label: 'Style II', color: '#da7777', preview: 'Night Stalker Remilia v2.webp', file: 'Night Stalker Remilia v2.zip' },
            ],
            tags: { effects: true, icons: true, anime: true },
            links: [{ type: 'source', url: 'https://www.3dmgame.com/' }]
        },
        { name: 'Death Prophet Yuyuko', preview: 'Death Prophet Yuyuko.webp', file: 'Death Prophet Yuyuko.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Ember Spirit Shana', preview: 'Ember Spirit Shana.webp', file: 'Ember Spirit Shana.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Gyrocopter Kongou', preview: 'Gyrocopter Kongou.webp', file: 'Gyrocopter Kongou.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Abaddon Sayaka Miki', preview: 'Abaddon Sayaka Miki.webp', file: 'Abaddon Sayaka Miki.zip', tags: { effects: false, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Troll Warlord Reimu', preview: 'Troll Warlord Reimu.webp', file: 'Troll Warlord Reimu.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Weaver Kurumi', preview: 'Weaver Kurumi.webp', file: 'Weaver Kurumi.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Tinker Sakuya', preview: 'Tinker Sakuya.webp', file: 'Tinker Sakuya.zip', tags: { effects: true, icons: false, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        ...
        { name: 'Abaddon Fallen King', preview: 'Abaddon Fallen King.webp', file: 'Abaddon Fallen King.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        ...
        { name: 'Shadow Fiend 1000-7', preview: 'Shadow Fiend 1000-7.webp', file: 'Shadow Fiend 1000-7.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'laskotdota' }] },
        { name: 'Green Earth Spirit', preview: 'Green Earth Spirit.webp', file: 'Green Earth Spirit.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Pangolier Gentleman', preview: 'Pangolier Gentleman.webp', file: 'Pangolier Gentleman.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        ...
        { name: 'Winter Lycan', preview: 'Winter Lycan.webp', file: 'Winter Lycan.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Dark Reaper Invoker', preview: 'Dark Reaper Invoker.webp', file: 'Dark Reaper Invoker.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Dark Ancient Slark', preview: 'Dark Ancient Slark.webp', file: 'Dark Ancient Slark.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Gothic Lifestealer', preview: 'Gothic Lifestealer.webp', file: 'Gothic Lifestealer.zip', tags: { effects: false, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Immortal Lich', preview: 'Immortal Lich.webp', file: 'Immortal Lich.zip', tags: { effects: true, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Abaddon Bloody Fallen King', preview: 'Abaddon Bloody Fallen King.webp', file: 'Abaddon Bloody Fallen King.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Lina Aerial Aphrodite Flame', preview: 'Lina Aerial Aphrodite Flame.webp', file: 'Lina Aerial Aphrodite Flame.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Young Invoker', preview: 'Young Invoker.webp', file: 'Young Invoker.zip', tags: { effects: false, icons: true }, links: [{ type: 'author', url: 'Kisilev' }] },
        ...
        { name: 'IO Histoire', preview: 'IO Histoire.webp', file: 'IO Histoire.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://vk.com/iselestiawaifu' }] },
        ...
        { name: 'Chen Lelouch', preview: 'Chen Lelouch.webp', file: 'Chen Lelouch.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'http://www.dota2rpg.com/forum.php?mod=viewthread&tid=2959&extra=page%3D1' }] },
        ...
        { name: 'Templar Assassin PlayBoy', preview: 'Templar Assassin PlayBoy.webp', file: 'Templar Assassin PlayBoy.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        { name: 'Bunshinjutsu Meepo', preview: 'Bunshinjutsu Meepo.webp', file: 'Bunshinjutsu Meepo.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Templar Assassin Whisper Gates', preview: 'Templar Assassin Whisper Gates.webp', file: 'Templar Assassin Whisper Gates.zip', tags: { effects: true, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        {
            ...
            tags: { effects: true, icons: true },
            links: [{ type: 'author', url: 'Kisilev' }]
        },
        { name: 'Viper Elephant Hawk Moth', preview: 'Viper Elephant Hawk Moth.webp', file: 'Viper Elephant Hawk Moth.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Blue Muerta', preview: 'Blue Muerta.webp', file: 'Blue Muerta.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Defiree' }] },
        {
        ...
        { name: 'Ancient Apparition Yoshino', preview: 'Ancient Apparition Yoshino.webp', file: 'Ancient Apparition Yoshino.zip', tags: { effects: false, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Axe Heracles', preview: 'Axe Heracles.webp', file: 'Axe Heracles.zip', tags: { effects: false, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Beastmaster Yuuki Yuuna', preview: 'Beastmaster Yuuki Yuuna.webp', file: 'Beastmaster Yuuki Yuuna.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Bounty Hunter Hei', preview: 'Bounty Hunter Hei.webp', file: 'Bounty Hunter Hei.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Axe Gawr Gura', preview: 'Axe Gawr Gura.webp', file: 'Axe Gawr Gura.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        // { name: 'Centaur Meliodas', preview: 'Centaur Meliodas.webp', file: 'Centaur Meliodas.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] }, vpk dead
        { name: 'Chaos Knight Flandre Scarlet', preview: 'Chaos Knight Flandre Scarlet.webp', file: 'Chaos Knight Flandre Scarlet.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Death Prophet BB', preview: 'Death Prophet BB.webp', file: 'Death Prophet BB.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Doom Jeanne Alter', preview: 'Doom Jeanne Alter.webp', file: 'Doom Jeanne Alter.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Grimstroke Arong', preview: 'Grimstroke Arong.webp', file: 'Grimstroke Arong.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Invoker Patchouli', preview: 'Invoker Patchouli.webp', file: 'Invoker Patchouli.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Death Prophet Unicorn', preview: 'Death Prophet Unicorn.webp', file: 'Death Prophet Unicorn.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Ember Spirit Mai Shiranui', preview: 'Ember Spirit Mai Shiranui.webp', file: 'Ember Spirit Mai Shiranui.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'Pinkpapa' }] },
        { name: 'Enchantress Shiro', preview: 'Enchantress Shiro.webp', file: 'Enchantress Shiro.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Enigma Blackhole Chan', preview: 'Enigma Blackhole Chan.webp', file: 'Enigma Blackhole Chan.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Faceless Void Esdeath', preview: 'Faceless Void Esdeath.webp', file: 'Faceless Void Esdeath.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Marci Atri', preview: 'Marci Atri.webp', file: 'Marci Atri.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Medusa Gilgamesh', preview: 'Medusa Gilgamesh.webp', file: 'Medusa Gilgamesh.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Leshrac Kokoro', preview: 'Leshrac Kokoro.webp', file: 'Leshrac Kokoro.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Lich Shokuhou Misaki', preview: 'Lich Shokuhou Misaki.webp', file: 'Lich Shokuhou Misaki.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Lifestealer Cong Yu', preview: 'Lifestealer Cong Yu.webp', file: 'Lifestealer Cong Yu.zip', tags: { effects: false, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Magnus Kirito', preview: 'Magnus Kirito.webp', file: 'Magnus Kirito.zip', tags: { effects: false, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Jakiro Kiyohime', preview: 'Jakiro Kiyohime.webp', file: 'Jakiro Kiyohime.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Juggernaut Okita Souji', preview: 'Juggernaut Okita Souji.webp', file: 'Juggernaut Okita Souji.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Keeper of the Light Tamamo', preview: 'Keeper of the Light Tamamo.webp', file: 'Keeper of the Light Tamamo.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Kez Nanami Yachiyo Kai', preview: 'Kez Nanami Yachiyo Kai.webp', file: 'Kez Nanami Yachiyo Kai.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Legion Commander Chen', preview: 'Legion Commander Chen.webp', file: 'Legion Commander Chen.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Faceless Void Rita', preview: 'Faceless Void Rita.webp', file: 'Faceless Void Rita.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Night Stalker Frost Walker', preview: 'Night Stalker Frost Walker.webp', file: 'Night Stalker Frost Walker.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Amir4an' }] },
        { name: 'Anti-Mage Blue Illidan', preview: 'Anti-Mage Blue Illidan.webp', file: 'Anti-Mage Blue Illidan.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Enchantress Darkwood Witness', preview: 'Enchantress Darkwood Witness.webp', file: 'Enchantress Darkwood Witness.zip', tags: { effects: false, icons: false } },
        { name: 'Hoodwink Bilge Rat Buccaneer', preview: 'Hoodwink Bilge Rat Buccaneer.webp', file: 'Hoodwink Bilge Rat Buccaneer.zip', tags: { effects: false, icons: false } },
        { name: 'Hoodwink Tomokan Footsoldier', preview: 'Hoodwink Tomokan Footsoldier.webp', file: 'Hoodwink Tomokan Footsoldier.zip', tags: { effects: false, icons: false } },
        { name: 'Pudge Candy Cat', preview: 'Pudge Candy Cat.webp', file: 'Pudge Candy Cat.zip', tags: { effects: false, icons: false } },
        { name: 'Pudge Iron Hog', preview: 'Pudge Iron Hog.webp', file: 'Pudge Iron Hog.zip', tags: { effects: false, icons: false } },
        { name: 'Pudge Mindless Slaughter', preview: 'Pudge Mindless Slaughter.webp', file: 'Pudge Mindless Slaughter.zip', tags: { effects: false, icons: false } },
        ...
        { name: 'Outworld Destroyer Dark Metter', preview: 'Outworld Destroyer Dark Metter.webp', file: 'Outworld Destroyer Dark Metter.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Amir4an' }] },
        ...
        { name: 'Naga Siren Izayoi Miku', preview: 'Naga Siren Izayoi Miku.webp', file: 'Naga Siren Izayoi Miku.zip', tags: { effects: false, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        ...
        { name: 'Legion Commander Persona', preview: 'Legion Commander Persona.webp', file: 'Legion Commander Persona.zip', tags: { effects: false, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Phite Phantom Assassin', preview: 'Phite Phantom Assassin.webp', file: 'Phite Phantom Assassin.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Brewmaster Military Saint', preview: 'Brewmaster Military Saint.webp', file: 'Brewmaster Military Saint.zip', tags: { effects: true, icons: false }, links: [{ type: 'author', url: 'Kisilev' }] },
        { name: 'Keeper of the Light Renegade', preview: 'Keeper of the Light Renegade.webp', file: 'Keeper of the Light Renegade.zip', tags: { effects: false, icons: false } },
        { name: 'Natures Prophet Saya', preview: 'Natures Prophet Saya.webp', file: 'Natures Prophet Saya.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Mirana Suigintou', preview: 'Mirana Suigintou.webp', file: 'Mirana Suigintou.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Ogre Magi Amakusa Shiro', preview: 'Ogre Magi Amakusa Shiro.webp', file: 'Ogre Magi Amakusa Shiro.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Necrophos Eucliwood Halsace', preview: 'Necrophos Eucliwood Halsace.webp', file: 'Necrophos Eucliwood Halsace.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Omniknight Akashi', preview: 'Omniknight Akashi.webp', file: 'Omniknight Akashi.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Oracle Irisviel von Einzbern', preview: 'Oracle Irisviel von Einzbern.webp', file: 'Oracle Irisviel von Einzbern.zip', tags: { effects: true, icons: true, anime: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
    ...
    'shaders': [
        { name: 'Aghanim Labyrinth', preview: 'aghanim_shader.webp', file: 'pak07_dir.vpk' },
        { name: 'Aghanim Purple', preview: 'Aghanim Purple Shader.webp', file: 'pak13_dir.vpk' },
        { name: 'Aghanim Peach', preview: 'Aghanim Peach Shader.webp', file: 'pak15_dir.vpk' },
        { name: 'Aghanim White', preview: 'Aghanim White Shader.webp', file: 'pak17_dir.vpk' },
        { name: 'Aghanim Green', preview: 'Aghanim Green Shader.webp', file: 'pak14_dir.vpk' },
        { name: 'Aghanim Red', preview: 'Aghanim Red Shader.webp', file: 'pak16_dir.vpk' },
        { name: 'Wave Purple', preview: 'Wave Purple Shader.webp', file: 'pak20_dir.vpk' },
        { name: 'Wave Peach', preview: 'Wave Peach Shader.webp', file: 'pak19_dir.vpk' },
        { name: 'Wave White', preview: 'Wave White Shader.webp', file: 'pak22_dir.vpk' },
        { name: 'Wave Green', preview: 'Wave Green Shader.webp', file: 'pak18_dir.vpk' },
        { name: 'Wave Red', preview: 'Wave Red Shader.webp', file: 'pak21_dir.vpk' },
        { name: 'Diretide (outline)', preview: 'diretide_shader.webp', file: 'pak08_dir.vpk' },
        { name: 'Haze', preview: 'haze_shader.webp', file: 'pak11_dir.vpk', links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Ancient', preview: 'ancient_shader.webp', file: 'pak10_dir.vpk', links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Purple Ancient', preview: 'purple_ancient_shader.webp', file: 'pak12_dir.vpk', links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Purple Outline', preview: 'Purple Outline Shader.webp', file: 'pak09_dir.vpk' },
    ...
    'ti-bp-effects': [
        ...
        { name: 'TI 2018 Battle Pass', preview: 'bp_ti8.webp', file: 'pak11_dir.vpk', linkType: 'preview', linkUrl: 'assets/previews/ti-bp-effects/TI_2018_Battle_Pass.mp4' },
        { name: 'TI 2017 Battle Pass', preview: 'bp_ti7.webp', file: 'pak12_dir.vpk', linkType: 'preview', linkUrl: 'assets/previews/ti-bp-effects/TI_2017_Battle_Pass.mp4' },
        { name: 'Winter 2016 Battle Pass', preview: 'bp_winter_2016.webp', file: 'pak13_dir.vpk', linkType: 'preview', linkUrl: 'assets/previews/ti-bp-effects/Winter_2016_Battle_Pass.mp4' },
        { name: 'TI 2016 Battle Pass', preview: 'bp_ti6.webp', file: 'pak14_dir.vpk', linkType: 'preview', linkUrl: 'assets/previews/ti-bp-effects/TI_2016_Battle_Pass.mp4' },
        { name: 'TI 2010 Battle Pass', preview: 'bp_ti10.webp', file: 'pak15_dir.vpk', linkType: 'preview', linkUrl: 'assets/previews/ti-bp-effects/TI_10_Battle_Pass.mp4' },
        { name: 'Nemestice 2021 Battle Pass', preview: 'bp_nemestice2021.webp', file: 'pak16_dir.vpk', linkType: 'preview', linkUrl: 'assets/previews/ti-bp-effects/Nemestice_2021_Battle_Pass.mp4' },
        { name: 'Aghanims Labyrinth Battle Pass', preview: 'bp_aghanim.webp', file: 'pak17_dir.vpk', linkType: 'preview', linkUrl: 'assets/previews/ti-bp-effects/Aghanims_Labyrinth_Battle_Pass.mp4' },
    ...
    'terrains': [
        ...
        { name: 'TI5 Desert Terrain', preview: 'TI5 Desert Terrain.webp', file: 'TI5 Desert Terrain.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'TI6 Immortal Gardens', preview: 'TI6 Immortal Gardens.webp', file: 'TI6 Immortal Gardens.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'TI7 Reefs Edge', preview: 'TI7 Reefs Edge.webp', file: 'TI7 Reefs Edge.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'TI8 Emerald Abyss', preview: 'TI8 Emerald Abyss.webp', file: 'TI8 Emerald Abyss.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'TI9 Overgrown Empire', preview: 'TI9 Overgrown Empire.webp', file: 'TI9 Overgrown Empire.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'TI10 Sanctum of the Divine', preview: 'TI10 Sanctum of the Divine.webp', file: 'TI10 Sanctum of the Divine.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'The Kings New Journey', preview: 'The Kings New Journey.webp', file: 'The Kings New Journey.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'Crownfall', preview: 'Crownfall.webp', file: 'Crownfall.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'Dota+ Winter', preview: 'Winter.webp', file: 'Winter.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'Dota+ Spring', preview: 'Spring.webp', file: 'Spring.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'Dota+ Summer', preview: 'Summer.webp', file: 'Summer.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
        { name: 'Dota+ Autumn', preview: 'Autumn.webp', file: 'Autumn.zip', links: [{ type: 'source', url: 'https://steamcommunity.com/sharedfiles/filedetails/?id=1664733222' }] },
    ],
    'trees': [
        { name: 'Pumpkin Trees', preview: 'Pumpkin Trees.webp', file: 'pak10_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-pumpkin_trees_up/' }] },
        { name: 'Small Trees Minify', preview: 'Small Trees.webp', file: 'pak11_dir.vpk', links: [{ type: 'author', url: 'Robbyz' }, { type: 'source', url: 'https://github.com/Egezenn/dota2-minify'}] },
        { name: 'Crystals Trees', preview: 'Crystals Trees.webp', file: 'pak12_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-blue_crystals_trees/' }] },
        { name: 'Wooden Trees', preview: 'Wooden Trees.webp', file: 'pak13_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-wooden_trees/' }] },
        { name: 'Stone Trees', preview: 'Stone Trees.webp', file: 'pak14_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-stone_forest_trees/' }] },
        { name: 'LowPoly Trees v1', preview: 'LowPoly Trees v1.webp', file: 'pak15_dir.vpk' },
        { name: 'Cartoon Trees', preview: 'Cartoon Trees.webp', file: 'pak16_dir.vpk', links: [{ type: 'author', url: 'Darkness' }] },
        { name: 'Pine Cone Trees', preview: 'Pine Cone Trees.webp', file: 'pak17_dir.vpk' },
        { name: 'Cone Trees', preview: 'Cone Trees.webp', file: 'pak18_dir.vpk' },
                ...
                id: 'lion', name: 'Lion', mods: [
                    ...
                    },
                    {
                        ...
                        styles: [
                            ...
                            { label: 'Exceptional', color: '#d8ff63', preview: 'Lion Fin Kings Charm Exceptional.webp', file: 'Lion Fin Kings Charm Exceptional.zip' },
                        ],
                        tags: { weapon: true, effects: true, icons: true }
                    },
                    {
                        name: 'Lion Mulctant Pall',
                        styles: [
                            { label: '', color: '#74b7ff', preview: 'Lion Mulctant Pall.webp', file: 'Lion Mulctant Pall.zip' },
                            { label: 'Crimson', color: '#ff7a7a', preview: 'Lion Mulctant Pall Crimson.webp', file: 'Lion Mulctant Pall Crimson.zip' },
                            { label: 'Purple', color: '#a27aff', preview: 'Lion Mulctant Pall Purple.webp', file: 'Lion Mulctant Pall Purple.zip' },
                        ],
                        tags: { armor: true, effects: true, icons: true }
                    },
                ]
            },
    ...
    'ancient': [
        { name: 'Ancient Dragon King', preview: 'Ancient Dragon King.webp', file: 'pak30_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-ancient_dragon_king/' }] },
    ...
    'ranged-attack': [
        ...
        { name: 'Aghanim Ranged Attack', preview: 'Aghanim Ranged Attack.webp', file: 'pak14_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
        { name: 'Green Diretide Ranged Attack', preview: 'Green Diretide Ranged Attack.webp', file: 'pak15_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
        { name: 'Blue Diretide Ranged Attack', preview: 'Diretide Blue.webp', file: 'pak16_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
        { name: 'Red Diretide Ranged Attack', preview: 'Diretide Red.webp', file: 'pak17_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
        { name: 'Yellow Diretide Ranged Attack', preview: 'Diretide Yellow.webp', file: 'pak18_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
        { name: 'TI12 Ranged Attack', preview: 'ti12.webp', file: 'pak19_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
        { name: 'TI10 Ranged Attack', preview: 'ti10.webp', file: 'pak20_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
        { name: 'TI9 Ranged Attack', preview: 'ti9.webp', file: 'pak21_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/' }] },
    ],
    'mega-kill': [
    ...
    'other': [
        { name: 'Profile Graffiti & Phrases', preview: 'Profile Graffiti & Phrases.webp', file: 'pak10_dir.vpk', linkType: 'author', linkUrl: 'https://steamcommunity.com/profiles/76561199145739904' },
    ...
    'backgrounds': [
        ...
        { name: 'Moonflower Field', preview: 'Moonflower Field.webp', file: 'pak12_dir.vpk', tags: { image: false, video: true } },
        { name: 'Forgotten Sword', preview: 'Forgotten Sword.webp', file: 'pak13_dir.vpk', tags: { image: false, video: true } },
        { name: 'Depressed SpongeBob', preview: 'Depressed SpongeBob.webp', file: 'pak14_dir.vpk', tags: { image: false, video: true } },
        { name: 'Lonely Quay', preview: 'Lonely Quay.webp', file: 'pak15_dir.vpk', tags: { image: false, video: true } },
        { name: 'Code Geass', preview: 'Code Geass.webp', file: 'pak16_dir.vpk', tags: { image: false, video: true } },
        { name: 'Winter Solitude', preview: 'Winter.webp', file: 'pak17_dir.vpk', tags: { image: false, video: true } },
        { name: 'Cloudy Tree', preview: 'Tree.webp', file: 'pak18_dir.vpk', tags: { image: false, video: true } },
        { name: 'Zenitsu White', preview: 'Zenitsu White.webp', file: 'pak19_dir.vpk', tags: { image: false, video: true } },
        { name: 'Nier Automata', preview: 'Nier Automata.webp', file: 'pak20_dir.vpk', tags: { image: false, video: true } },
        { name: 'Kurumi Tokisaki', preview: 'Kurumi Tokisaki.webp', file: 'pak21_dir.vpk', tags: { image: false, video: true } },
        { name: 'Sad Maomao', preview: 'Sad Maomao.webp', file: 'pak22_dir.vpk', tags: { image: false, video: true } },
        { name: 'Dead Eyes', preview: 'Dead Eyes.webp', file: 'pak23_dir.vpk', tags: { image: false, video: true } },
        { name: 'Katana In Forest', preview: 'Katana In Forest.webp', file: 'pak24_dir.vpk', tags: { image: false, video: true } },
        { name: 'Field Grass', preview: 'Field Grass.webp', file: 'pak25_dir.vpk', tags: { image: false, video: true } },
        { name: 'Snowfall In Forest', preview: 'Snowfall In Forest.webp', file: 'pak26_dir.vpk', tags: { image: false, video: true } },
        { name: 'Cyrene Song', preview: 'Cyrene Song.webp', file: 'pak27_dir.vpk', tags: { image: false, video: true } },
        { name: 'Blossom Rem', preview: 'Blossom Rem.webp', file: 'pak28_dir.vpk', tags: { image: false, video: true } },
        { name: 'Kakehashi Subaru', preview: 'Kakehashi Subaru.webp', file: 'pak29_dir.vpk', tags: { image: false, video: true } },
        { name: 'Ichigo', preview: 'Ichigo.webp', file: 'pak30_dir.vpk', tags: { image: false, video: true } },
        { name: 'Liberalio Nikke', preview: 'Liberalio Nikke.webp', file: 'pak31_dir.vpk', tags: { image: false, video: true } },
        { name: 'Rainy Girl', preview: 'Rainy Girl.webp', file: 'pak32_dir.vpk', tags: { image: false, video: true } },
        { name: 'Rei Ayanami', preview: 'Rei Ayanami.webp', file: 'pak33_dir.vpk', tags: { image: false, video: true } },
        { name: 'Ulquiorra', preview: 'Ulquiorra.webp', file: 'pak34_dir.vpk', tags: { image: false, video: true } },
        ...
        { name: 'Lelouch Lamperouge', preview: 'Lelouch Lamperouge.webp', file: 'pak38_dir.vpk', tags: { image: false, video: true } },
        { name: 'Kira and Ryuk', preview: 'Kira and Ryuk.webp', file: 'pak39_dir.vpk', tags: { image: false, video: true } },
        { name: 'Garden of Quiet Days', preview: 'Garden of Quiet Days.webp', file: 'pak40_dir.vpk', tags: { image: false, video: true } },
        { name: 'Floating Dog', preview: 'Floating Dog.webp', file: 'pak41_dir.vpk', tags: { image: false, video: true } },
        { name: 'Corgi Sleeping', preview: 'Corgi Sleeping.webp', file: 'pak42_dir.vpk', tags: { image: false, video: true } },
        { name: 'Cat Under Rain', preview: 'Cat Under Rain.webp', file: 'pak43_dir.vpk', tags: { image: false, video: true } },
        { name: 'Fallen Paladin', preview: 'Fallen Paladin.webp', file: 'pak44_dir.vpk', tags: { image: false, video: true } },
        { name: 'Nikaido Hiro', preview: 'Nikaido Hiro.webp', file: 'pak45_dir.vpk', tags: { image: false, video: true } },
        { name: 'Winter Forest', preview: 'Winter Forest.webp', file: 'pak46_dir.vpk', tags: { image: false, video: true } },
        { name: 'Knight Artorias', preview: 'Knight Artorias.webp', file: 'pak47_dir.vpk', tags: { image: false, video: true } },
        { name: 'Guts', preview: 'Guts.webp', file: 'pak48_dir.vpk', tags: { image: false, video: true } },
        { name: 'Minecraft Rain', preview: 'Minecraft Rain.webp', file: 'pak49_dir.vpk', tags: { image: false, video: true } },
        { name: 'Old Bus Stop', preview: 'Old Bus Stop.webp', file: 'pak50_dir.vpk', tags: { image: false, video: true } },
    ...
    'tools': [
        ...
        { name: 'VPKTool - Extract & Pack VPKs', preview: 'VPKTool.webp', multiPlatform: true, fileWin: 'https://github.com/h6rd/VPKTool/releases/latest/download/VPKTool-Win.zip', fileLinux: 'https://github.com/h6rd/VPKTool/releases/latest/download/VPKTool-Linux.zip', type: 'guide', guideId: 'vpk-tool', linkType: 'source-code', linkUrl: 'https://github.com/h6rd/VPKTool' },
        { name: 'VPKMerge - Combine VPKs', preview: 'VPKMerge.webp', multiPlatform: true, fileWin: 'https://github.com/h6rd/VPKMerge/releases/latest/download/VPKMerge-Win.zip', fileLinux: 'https://github.com/h6rd/VPKMerge/releases/latest/download/VPKMerge-Linux.zip', type: 'guide', guideId: 'vpk-merge', linkType: 'source-code', linkUrl: 'https://github.com/h6rd/VPKMerge' },
        ...
        // { name: 'Cursor Changer', preview: 'Cursor Changer.webp', file: 'Cursor Changer.zip', links: [{ type: 'source-code', url: 'https://github.com/dxrkflxtter/Dota2-Cursor-Changer' }, { type: 'author', url: 'https://github.com/dxrkflxtter' }]},
    ],
    'optimization': [
    ...
    'sites': [
        ...
        { name: 'Dota2 Emoticons', preview: 'Dota2EmojiNickname.webp', file: 'https://aluerie.github.io/Dota2Utils/ListEmoticons/', type: 'guide', tags: { fun: false } },
    ...
    'couriers': [
        ...
        { name: 'Baby Roshan 2017', preview: 'Baby Roshan 2017.webp', file: 'pak22_dir.vpk', guideId: 'couriers-info', guideType: 'info' },
        { name: 'Desert Sands Baby Roshan', preview: 'Desert Sands Baby Roshan.webp', file: 'pak23_dir.vpk', guideId: 'couriers-info', guideType: 'info' },
        { name: 'Golden Doomling', preview: 'Golden Doomling.webp', file: 'pak24_dir.vpk', guideId: 'couriers-info', guideType: 'info' },
        { name: 'Golden Seekling', preview: 'Golden Seekling.webp', file: 'pak25_dir.vpk', guideId: 'couriers-info', guideType: 'info' },
        { name: 'Golden Venoling', preview: 'Golden Venoling.webp', file: 'pak26_dir.vpk', guideId: 'couriers-info', guideType: 'info' },
        { name: 'Golden Huntling', preview: 'Golden Huntling.webp', file: 'pak27_dir.vpk', guideId: 'couriers-info', guideType: 'info' },
        { name: 'Golden Flopjaw the Boxhound', preview: 'Golden Flopjaw the Boxhound.webp', file: 'pak28_dir.vpk', guideId: 'couriers-info', guideType: 'info' },
    ...
    'cursors': [
        ...
        { name: 'Simple Cursor', preview: 'Simple Cursor.webp', file: 'Simple Cursor.zip', links: [{ type: 'author', url: 'https://t.me/slipersone' }] },
        { name: 'Azur Lane Cursor', preview: 'Azur Lane Cursor.webp', file: 'Azur Lane Cursor.zip', links: [{ type: 'source', url: 'https://vk.com/@dota2animemods-ui-dota-mod' }] },
        { name: 'White Necronub Cursor', preview: 'White Necronub Cursor.webp', file: 'White Necronub Cursor.zip', links: [{ type: 'author', url: 'NahuiToSay' }] },
        { name: 'SpearMa Cursor', preview: 'SpearMa Cursor.webp', file: 'SpearMa Cursor.zip', links: [{ type: 'author', url: 'ya_lyosha' }] },
    ],
    'fonts': [
    ...
    'packs': [
        {
            ...
            mods: [
                ...
                'Dota+ Winter',
                'Nemestice Radiant Creeps',
                'Nemestice Dire Creeps',
                'Deny Fall 2021',
                'Snowfall In Forest',
                'Floes Tower',
                'Baby Roshan 2018',
                'Snow Dagon',
                'Christmas Iron Branch',
                'Winter Hex',
        ...
        groups: [
            {
                id: 'radiant-tower', name: 'Radiant Tower', mods: [
                    { name: 'Holiday Radiant Tower', preview: 'Holiday Radiant Tower.webp', file: 'pak10_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-holiday_radiant_tower/' }] },
        ...
        groups: [
            ...
            },
            {
                id: 'runes', name: 'Runes', mods: [
                    { name: 'Custom Runes', preview: 'Custom Runes.webp', file: 'pak33_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-custom_runes/' }] },
            ...
            },
            {
                id: 'blink', name: 'Blink Dagger', mods: [
                    ...
                    { name: 'Darkness Blink Dagger', preview: 'Darkness Blink Dagger.webp', file: 'Darkness Blink Dagger.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
                id: 'bottle', name: 'Bottle', mods: [
                    ...
                    { name: 'Red Bottle', preview: 'Red Bottle.webp', file: 'pak50_dir.vpk', links: [{ type: 'source', url: 'https://dota2changer.com/skins_dota_2_mods-red_bottle_effect/' }] },
                    { name: 'Darkness Bottle', preview: 'Darkness Bottle.webp', file: 'Darkness Bottle.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
                id: 'eul', name: "Eul's / Wind Waker", mods: [
                    ...
                    { name: 'Darkness Euls Scepter', preview: 'Darkness Euls Scepter.webp', file: 'Darkness Euls Scepter.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
            ...
            },
            {
                id: 'lvlup', name: 'Lvl Up', mods: [
                    ...
                    { name: 'Darkness Lvl Up', preview: 'Darkness Lvl up.webp', file: 'Darkness Lvl up.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
                id: 'shivas', name: "Shiva's Guard", mods: [
                    ...
                    { name: 'Darkness Shiva', preview: 'Darkness Shivas.webp', file: 'Darkness Shivas.zip', links: [{ type: 'author', url: 'Darkness' }] }
                ]
            },
            {
                id: 'mekanism', name: 'Mekanism', mods: [
                    ...
                    { name: 'Darkness Mekanism', preview: 'Darkness Mekanism.webp', file: 'Darkness Mekanism.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
                id: 'mjollnir', name: 'Maelstrom / Mjollnir', mods: [
                    ...
                    { name: 'Darkness Mjollnir', preview: 'Darkness Mjollner.webp', file: 'Darkness Mjollner.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
                id: 'radiance', name: 'Radiance', mods: [
                    ...
                    { name: 'Darkness Radiance', preview: 'Darkness Radiance.webp', file: 'Darkness Radiance.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
                id: 'phase-boots', name: 'Phase Boots', mods: [
                    ...
                    { name: 'Darkness Phase Boots', preview: 'Darkness Phase Boots.webp', file: 'Darkness Phase Boots.zip', links: [{ type: 'author', url: 'Darkness' }] },
                ]
            },
            {
