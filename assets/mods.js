const recentlyAddedMods = [
    ...
    { name: 'Pudge Mindless Slaughter', category: 'heroes' },
    { name: 'Pudge Iron Hog', category: 'heroes' },
    { name: 'Pudge Candy Cat', category: 'heroes' },
    { name: 'Hoodwink Tomokan Footsoldier', category: 'heroes' },
    { name: 'Hoodwink Bilge Rat Buccaneer', category: 'heroes' },
    { name: 'Enchantress Darkwood Witness', category: 'heroes' },
    ...
    { name: 'Keeper of the Light Tamamo', category: 'heroes' },
    { name: 'Juggernaut Okita Souji', category: 'heroes' },
    { name: 'Jakiro Kiyohime', category: 'heroes' },
    { name: 'Magnus Kirito', category: 'heroes' },
    { name: 'Lifestealer Cong Yu', category: 'heroes' },
    { name: 'Lich Shokuhou Misaki', category: 'heroes' },
    { name: 'Leshrac Kokoro', category: 'heroes' },
    { name: 'Medusa Gilgamesh', category: 'heroes' },
    { name: 'Marci Atri', category: 'heroes' },
    { name: 'Faceless Void Esdeath', category: 'heroes' },
    { name: 'Enigma Blackhole Chan', category: 'heroes' },
    { name: 'Enchantress Shiro', category: 'heroes' },
    { name: 'Ember Spirit Mai Shiranui', category: 'heroes' },
    { name: 'Death Prophet Unicorn', category: 'heroes' },
    { name: 'Invoker Patchouli', category: 'heroes' },
    { name: 'Grimstroke Arong', category: 'heroes' },
    { name: 'Doom Jeanne Alter', category: 'heroes' },
    { name: 'Death Prophet BB', category: 'heroes' },
    { name: 'Chaos Knight Flandre Scarlet', category: 'heroes' },
    { name: 'Centaur Meliodas', category: 'heroes' },
    { name: 'Axe Gawr Gura', category: 'heroes' },
    { name: 'Bounty Hunter Hei', category: 'heroes' },
    { name: 'Beastmaster Yuuki Yuuna', category: 'heroes' },
    { name: 'Axe Heracles', category: 'heroes' },
    { name: 'Ancient Apparition Yoshino', category: 'heroes' },
    { name: 'Remove Seasonal Effects', category: 'ti-bp-effects' },
    { name: 'Wave Lite Purple', category: 'shaders' },
...
const modsData = {
    'heroes': [
        ...
        { name: 'Night Stalker Remilia', preview: 'Night Stalker Remilia.webp', file: 'Night Stalker Remilia.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        ...
        { name: 'Death Prophet BB', preview: 'Death Prophet BB.webp', file: 'Death Prophet BB.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Doom Jeanne Alter', preview: 'Doom Jeanne Alter.webp', file: 'Doom Jeanne Alter.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        ...
        { name: 'Medusa Gilgamesh', preview: 'Medusa Gilgamesh.webp', file: 'Medusa Gilgamesh.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        ...
        { name: 'Keeper of the Light Tamamo', preview: 'Keeper of the Light Tamamo.webp', file: 'Keeper of the Light Tamamo.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
