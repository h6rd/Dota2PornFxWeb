...
const modsData = {
    'heroes': [
        ...
        { name: 'Wraith King Itsuka Kotori', preview: 'Wraith King Itsuka Kotori.webp', file: 'Wraith King Itsuka Kotori.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Sven Yatogami Tohka', preview: 'Sven Yatogami Tohka.webp', file: 'Sven Yatogami Tohka.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Sven Yatogami Tohka v2', preview: 'Sven Yatogami Tohka v2.webp', file: 'Sven Yatogami Tohka v2.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Crystal Maiden Cirno', preview: 'Crystal Maiden Cirno.webp', file: 'Crystal Maiden Cirno.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Bane Komeiji Koishi', preview: 'Bane Komeiji Koishi.webp', file: 'Bane Komeiji Koishi.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Outworld Destroyer Yukari', preview: 'Outworld Destroyer Yukari Yakumo.webp', file: 'Outworld Destroyer Yukari Yakumo.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Phantom Assassin Rory', preview: 'Phantom Assassin Rory Mercury.webp', file: 'Phantom Assassin Rory Mercury.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Lich Miyuki Shiba', preview: 'Lich Miyuki Shiba.webp', file: 'Lich Miyuki Shiba.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Legion Commander Nero', preview: 'Legion Commander Nero.webp', file: 'Legion Commander Nero.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        {
        ...
        { name: 'Death Prophet Yuyuko', preview: 'Death Prophet Yuyuko.webp', file: 'Death Prophet Yuyuko.zip', tags: { effects: true, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Ember Spirit Shana', preview: 'Ember Spirit Shana.webp', file: 'Ember Spirit Shana.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Gyrocopter Kongou', preview: 'Gyrocopter Kongou.webp', file: 'Gyrocopter Kongou.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Abaddon Sayaka Miki', preview: 'Abaddon Sayaka Miki.webp', file: 'Abaddon Sayaka Miki.zip', tags: { effects: false, icons: false }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        ...
        { name: 'Axe Heracles', preview: 'Axe Heracles.webp', file: 'Axe Heracles.zip', tags: { effects: false, icons: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        ...
        { name: 'Grimstroke Arong', preview: 'Grimstroke Arong.webp', file: 'Grimstroke Arong.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Invoker Patchouli', preview: 'Invoker Patchouli.webp', file: 'Invoker Patchouli.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Death Prophet Unicorn', preview: 'Death Prophet Unicorn.webp', file: 'Death Prophet Unicorn.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Ember Spirit Mai Shiranui', preview: 'Ember Spirit Mai Shiranui.webp', file: 'Ember Spirit Mai Shiranui.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'Pinkpapa' }] },
        { name: 'Enchantress Shiro', preview: 'Enchantress Shiro.webp', file: 'Enchantress Shiro.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Enigma Blackhole Chan', preview: 'Enigma Blackhole Chan.webp', file: 'Enigma Blackhole Chan.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Faceless Void Esdeath', preview: 'Faceless Void Esdeath.webp', file: 'Faceless Void Esdeath.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Marci Atri', preview: 'Marci Atri.webp', file: 'Marci Atri.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Medusa Gilgamesh', preview: 'Medusa Gilgamesh.webp', file: 'Medusa Gilgamesh.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Leshrac Kokoro', preview: 'Leshrac Kokoro.webp', file: 'Leshrac Kokoro.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Lich Shokuhou Misaki', preview: 'Lich Shokuhou Misaki.webp', file: 'Lich Shokuhou Misaki.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Lifestealer Cong Yu', preview: 'Lifestealer Cong Yu.webp', file: 'Lifestealer Cong Yu.zip', tags: { effects: false, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Magnus Kirito', preview: 'Magnus Kirito.webp', file: 'Magnus Kirito.zip', tags: { effects: false, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Jakiro Kiyohime', preview: 'Jakiro Kiyohime.webp', file: 'Jakiro Kiyohime.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Juggernaut Okita Souji', preview: 'Juggernaut Okita Souji.webp', file: 'Juggernaut Okita Souji.zip', tags: { effects: true, icons: true }, links: [{ type: 'source', url: 'https://www.3dmgame.com/' }] },
        { name: 'Keeper of the Light Tamamo', preview: 'Keeper of the Light Tamamo.webp', file: 'Keeper of the Light Tamamo.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        ...
        { name: 'Natures Prophet Saya', preview: 'Natures Prophet Saya.webp', file: 'Natures Prophet Saya.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Mirana Suigintou', preview: 'Mirana Suigintou.webp', file: 'Mirana Suigintou.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
        { name: 'Ogre Magi Amakusa Shiro', preview: 'Ogre Magi Amakusa Shiro.webp', file: 'Ogre Magi Amakusa Shiro.zip', tags: { effects: true, icons: true }, links: [{ type: 'author', url: 'SanyaBane' }] },
