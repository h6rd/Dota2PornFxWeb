...
function addToCart(mod, categoryId) {
    ...
    const SINGLE_ITEM_CATEGORIES = ['terrains', 'shaders', 'creep-deny', 'ti-bp-effects', 'emblems', 'versus-screens', 'trees', 'roshan', 'creeps', 'ancient', 'tormentor', 'towers', 'ranged-attack', 'mega-kill', 'pedestal', 'high-five', 'backgrounds', 'river', 'ranks'];
