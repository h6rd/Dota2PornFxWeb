...
const modsData = {
    ...
    'heroes': [
        { name: 'Alien Nyx Assassin', preview: 'Alien Nyx Assassin.mp4', file: 'Alien Nyx Assassin.zip', tags: { effects: true, items: true } },
        { name: 'Ancients Lina', preview: 'Ancients Lina.mp4', file: 'Ancients Lina.zip', tags: { effects: true, items: true } },
        { name: 'Arc Warden Black Hole', preview: 'Arc Warden Black Hole.mp4', file: 'Arc Warden Black Hole.zip', tags: { effects: true, items: true } },
        { name: 'Arc Warden Sakura Winter', preview: 'Arc Warden Sakura Winter.mp4', file: 'Arc Warden Sakura Winter.zip', tags: { effects: true, items: true } },
        { name: 'Ashes Arc Warden', preview: 'Ashes Arc Warden.mp4', file: 'Ashes Arc Warden.zip', tags: { effects: true, items: true } },
        { name: 'Axe Immortal Bootblack', preview: 'Axe Immortal Bootblack.mp4', file: 'Axe Immortal Bootblack.zip', tags: { effects: true, items: false } },
        { name: 'Bare Brewmaster 🥸', preview: 'Bare Brewmaster.mp4', file: 'Bare Brewmaster.zip', tags: { effects: false, items: false } },
        { name: 'Bloody Enigma', preview: 'Bloody Enigma.mp4', file: 'Bloody Enigma.zip', tags: { effects: true, items: true } },
        { name: 'Bloody Kez', preview: 'Bloody Kez.mp4', file: 'Bloody Kez.zip', tags: { effects: true, items: false } },
        { name: 'Brewmaster Jousting Panda', preview: 'Brewmaster Jousting Panda.mp4', file: 'Brewmaster Jousting Panda.zip', tags: { effects: false, items: false } },
        { name: 'Broodmother Redan', preview: 'Broodmother Redan.mp4', file: 'Broodmother Redan.zip', tags: { effects: true, items: true } },
        { name: 'Clinkz Silver Metall Pink', preview: 'Clinkz Silver Metall Pink.mp4', file: 'Clinkz Silver Metall Pink.zip', tags: { effects: true, items: true } },
        { name: 'Darkness Weaver', preview: 'Darkness Weaver.mp4', file: 'Darkness Weaver.zip', tags: { effects: true, items: true } },
        { name: 'Drow Ranger Stranger Arcana', preview: 'Drow Ranger Stranger Arcana.mp4', file: 'Drow Ranger Stranger Arcana.zip', tags: { effects: true, items: false } },
        { name: 'Earthshaker Red Arcana', preview: 'Earthshaker Red Arcana.mp4', file: 'Earthshaker Red Arcana.zip', tags: { effects: false, items: true } },
        { name: 'Ghost Fiend', preview: 'Ghost Fiend.mp4', file: 'Ghost Fiend.zip', tags: { effects: true, items: true } },
        { name: 'Ghosty Slark', preview: 'Ghosty Slark.mp4', file: 'Ghosty Slark.zip', tags: { effects: true, items: true } },
        { name: 'GopoPudge 🥰', preview: 'GopoPudge.mp4', file: 'GopoPudge.zip', tags: { effects: false, items: false } },
        { name: 'GopoTide 🥰', preview: 'GopoTide.mp4', file: 'GopoTide.zip', tags: { effects: false, items: false } },
        { name: 'Ice Phoenix', preview: 'Ice Phoenix.mp4', file: 'Ice Phoenix.zip', tags: { effects: true, items: true } },
        { name: 'Ice Venomancer', preview: 'Ice Venomancer.mp4', file: 'Ice Venomancer.zip', tags: { effects: true, items: true } },
        { name: 'IO Pink Arcana', preview: 'IO Pink Arcana.mp4', file: 'IO Pink Arcana.zip', tags: { effects: true, items: true } },
        { name: 'IO Purple', preview: 'Purple IO.mp4', file: 'IO Purple.zip', tags: { effects: true, items: true } },
        { name: 'Kai Meepo', preview: 'Kai Meepo.mp4', file: 'Kai Meepo.zip', tags: { effects: true, items: true } },
        { name: 'Legion Commander Crimson Black', preview: 'Legion Commander Crimson Black.mp4', file: 'Legion Commander Crimson Black.zip', tags: { effects: true, items: true } },
        { name: 'Lion Cannonroar Confessor', preview: 'Lion Cannonroar Confessor.mp4', file: 'Lion Cannonroar Confessor.zip', tags: { effects: true, items: true } },
        { name: 'Lion Dark Magician Girl', preview: 'Lion Dark Magician Girl.mp4', file: 'Lion Dark Magician Girl.zip', tags: { effects: true, items: true } },
        { name: 'Morphling Darktrench Stalker Purple', preview: 'Morphling Darktrench Stalker Purple.mp4', file: 'Morphling Darktrench Stalker Purple.zip', tags: { effects: true, items: true } },
        { name: 'Natures Prophet Allfather', preview: 'Natures Prophet Allfather.mp4', file: 'Natures Prophet Allfather.zip', tags: { effects: true, items: true } },
        { name: 'Nightmare Chaos Knight', preview: 'Nightmare Chaos Knight.mp4', file: 'Nightmare Chaos Knight.zip', tags: { effects: true, items: true } },
        { name: 'Ogre Magi Custom Arcana', preview: 'Ogre Magi Custom Arcana.mp4', file: 'Ogre Magi Custom Arcana.zip', tags: { effects: false, items: false } },
        { name: 'Old Storm Spirit', preview: 'Old Storm Spirit.mp4', file: 'Old Storm Spirit.zip', tags: { effects: true, items: true } },
        { name: 'Pudge Arcana Elephant', preview: 'Pudge Arcana Elephant.mp4', file: 'Pudge Arcana Elephant.zip', tags: { effects: true, items: false } },
        { name: 'Pudge CM', preview: 'Pudge CM.mp4', file: 'Pudge CM.zip', tags: { effects: false, items: false } },
        { name: 'Queen of Pain Rose', preview: 'Queen of Pain Rose.mp4', file: 'Queen of Pain Rose.zip', tags: { effects: true, items: true } },
        { name: 'Russian Ursa', preview: 'Russian Ursa.mp4', file: 'Russian Ursa.zip', tags: { effects: false, items: false } },
        { name: 'Scarlet Keeper', preview: 'Scarlet Keeper.mp4', file: 'Scarlet Keeper.zip', tags: { effects: true, items: true } },
        { name: 'Shadow Fiend White', preview: 'Shadow Fiend White.mp4', file: 'Shadow Fiend White.zip', tags: { effects: true, items: true } },
        { name: 'Shadow Shaman Purple', preview: 'Shadow Shaman Purple.mp4', file: 'Shadow Shaman Purple.zip', tags: { effects: true, items: false } },
        { name: 'Spectre Toxin', preview: 'Spectre Toxin.mp4', file: 'Spectre Toxin.zip', tags: { effects: true, items: true } },
        { name: 'Spirit Breaker Ghost Monster', preview: 'Spirit Breaker Ghost Monster.mp4', file: 'Spirit Breaker Ghost Monster.zip', tags: { effects: true, items: true } },
        { name: 'Steel King', preview: 'Steel King.mp4', file: 'Steel King.zip', tags: { effects: true, items: true } },
        { name: 'The Mawsworn Razor', preview: 'The Mawsworn Razor.mp4', file: 'The Mawsworn Razor.zip', tags: { effects: true, items: false } },
        { name: 'Ursa White and Red', preview: 'Ursa White and Red.mp4', file: 'Ursa White and Red.zip', tags: { effects: true, items: true } },
        { name: 'Warlock Puppet Bear', preview: 'Warlock Puppet Bear.mp4', file: 'Warlock Puppet Bear.zip', tags: { effects: true, items: false } },
        { name: 'Winter Ember Spirit', preview: 'Winter Ember Spirit.mp4', file: 'Winter Ember Spirit.zip', tags: { effects: true, items: true } }
    ],
    'roshan': [
