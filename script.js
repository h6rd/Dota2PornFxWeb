...
const modsData = {
    ...
    'terrains': [
        { name: 'TI5 Desert Terrain', preview: 'TI5 Desert Terrain.jpg', file: 'TI5 Desert Terrain.zip' },
        { name: 'TI6 Immortal Gardens', preview: 'TI6 Immortal Gardens.jpg', file: 'TI6 Immortal Gardens.zip' },
        { name: 'TI7 Reefs Edge', preview: 'TI7 Reefs Edge.jpg', file: 'TI7 Reefs Edge.zip' },
        { name: 'TI8 Emerald Abyss', preview: 'TI8 Emerald Abyss.jpg', file: 'TI8 Emerald Abyss.zip' },
        { name: 'TI9 Overgrown Empire', preview: 'TI9 Overgrown Empire.jpg', file: 'TI9 Overgrown Empire.zip' },
        { name: 'TI10 Sanctum of the Divine', preview: 'TI10 Sanctum of the Divine.jpg', file: 'TI10 Sanctum of the Divine.zip' },
        { name: 'The Kings New Journey', preview: 'The Kings New Journey.jpg', file: 'The Kings New Journey.zip' },
        { name: 'Winter', preview: 'Winter.jpg', file: 'Winter.zip' },
        { name: 'Spring', preview: 'Spring.jpg', file: 'Spring.zip' },
        { name: 'Summer', preview: 'Summer.jpg', file: 'Summer.zip' },
        { name: 'Autumn', preview: 'Autumn.jpg', file: 'Autumn.zip' },
        { name: 'Crownfall', preview: 'Crownfall.jpg', file: 'Crownfall.zip' },
    ...
    'heroes': [
        { name: 'Alien Nyx Assassin', preview: 'Alien Nyx Assassin.png', file: 'Alien Nyx Assassin.zip', tags: { effects: true, icons: true } },
        { name: 'Ancients Lina', preview: 'Ancients Lina.png', file: 'Ancients Lina.zip', tags: { effects: true, icons: true } },
        { name: 'Arc Warden Black Hole', preview: 'Arc Warden Black Hole.png', file: 'Arc Warden Black Hole.zip', tags: { effects: true, icons: true } },
        { name: 'Arc Warden Sakura Winter', preview: 'Arc Warden Sakura Winter.png', file: 'Arc Warden Sakura Winter.zip', tags: { effects: true, icons: true } },
        { name: 'Ashes Arc Warden', preview: 'Ashes Arc Warden.png', file: 'Ashes Arc Warden.zip', tags: { effects: true, icons: true } },
        { name: 'Axe Immortal Bootblack', preview: 'Axe Immortal Bootblack.png', file: 'Axe Immortal Bootblack.zip', tags: { effects: true, icons: false } },
        { name: 'Bare Brewmaster 🥸', preview: 'Bare Brewmaster.png', file: 'Bare Brewmaster.zip', tags: { effects: false, icons: false } },
        { name: 'Bloody Enigma', preview: 'Bloody Enigma.png', file: 'Bloody Enigma.zip', tags: { effects: true, icons: true } },
        { name: 'Bloody Kez', preview: 'Bloody Kez.png', file: 'Bloody Kez.zip', tags: { effects: true, icons: false } },
        { name: 'Brewmaster Jousting Panda', preview: 'Brewmaster Jousting Panda.png', file: 'Brewmaster Jousting Panda.zip', tags: { effects: false, icons: false } },
        { name: 'Broodmother Redan', preview: 'Broodmother Redan.png', file: 'Broodmother Redan.zip', tags: { effects: true, icons: true } },
        { name: 'Clinkz Silver Metall Pink', preview: 'Clinkz Silver Metall Pink.png', file: 'Clinkz Silver Metall Pink.zip', tags: { effects: true, icons: true } },
        { name: 'Darkness Weaver', preview: 'Darkness Weaver.png', file: 'Darkness Weaver.zip', tags: { effects: true, icons: true } },
        { name: 'Drow Ranger Stranger Arcana', preview: 'Drow Ranger Stranger Arcana.png', file: 'Drow Ranger Stranger Arcana.zip', tags: { effects: true, icons: false } },
        { name: 'Earthshaker Red Arcana', preview: 'Earthshaker Red Arcana.png', file: 'Earthshaker Red Arcana.zip', tags: { effects: false, icons: true } },
        { name: 'Ghost Fiend', preview: 'Ghost Fiend.png', file: 'Ghost Fiend.zip', tags: { effects: true, icons: true } },
        { name: 'Ghosty Slark', preview: 'Ghosty Slark.png', file: 'Ghosty Slark.zip', tags: { effects: true, icons: true } },
        { name: 'GopoPudge 🥰', preview: 'GopoPudge.png', file: 'GopoPudge.zip', tags: { effects: false, icons: false } },
        { name: 'GopoTide 🥰', preview: 'GopoTide.png', file: 'GopoTide.zip', tags: { effects: false, icons: false } },
        { name: 'Ice Phoenix', preview: 'Ice Phoenix.png', file: 'Ice Phoenix.zip', tags: { effects: true, icons: true } },
        { name: 'Ice Venomancer', preview: 'Ice Venomancer.png', file: 'Ice Venomancer.zip', tags: { effects: true, icons: true } },
        { name: 'IO Pink Arcana', preview: 'IO Pink Arcana.png', file: 'IO Pink Arcana.zip', tags: { effects: true, icons: true } },
        { name: 'IO Purple', preview: 'Purple IO.png', file: 'IO Purple.zip', tags: { effects: true, icons: true } },
        { name: 'Kai Meepo', preview: 'Kai Meepo.png', file: 'Kai Meepo.zip', tags: { effects: true, icons: true } },
        { name: 'Legion Commander Crimson Black', preview: 'Legion Commander Crimson Black.png', file: 'Legion Commander Crimson Black.zip', tags: { effects: true, icons: true } },
        { name: 'Lion Cannonroar Confessor', preview: 'Lion Cannonroar Confessor.png', file: 'Lion Cannonroar Confessor.zip', tags: { effects: true, icons: true } },
        { name: 'Lion Dark Magician Girl', preview: 'Lion Dark Magician Girl.png', file: 'Lion Dark Magician Girl.zip', tags: { effects: true, icons: true } },
        { name: 'Morphling Darktrench Stalker Purple', preview: 'Morphling Darktrench Stalker Purple.png', file: 'Morphling Darktrench Stalker Purple.zip', tags: { effects: true, icons: true } },
        { name: 'Natures Prophet Allfather', preview: 'Natures Prophet Allfather.png', file: 'Natures Prophet Allfather.zip', tags: { effects: true, icons: true } },
        { name: 'Nightmare Chaos Knight', preview: 'Nightmare Chaos Knight.png', file: 'Nightmare Chaos Knight.zip', tags: { effects: true, icons: true } },
        { name: 'Ogre Magi Custom Arcana', preview: 'Ogre Magi Custom Arcana.png', file: 'Ogre Magi Custom Arcana.zip', tags: { effects: false, icons: false } },
        { name: 'Old Storm Spirit', preview: 'Old Storm Spirit.png', file: 'Old Storm Spirit.zip', tags: { effects: true, icons: true } },
        { name: 'Pudge Arcana Elephant', preview: 'Pudge Arcana Elephant.png', file: 'Pudge Arcana Elephant.zip', tags: { effects: true, icons: false } },
        { name: 'Pudge CM', preview: 'Pudge CM.png', file: 'Pudge CM.zip', tags: { effects: false, icons: false } },
        { name: 'Queen of Pain Rose', preview: 'Queen of Pain Rose.png', file: 'Queen of Pain Rose.zip', tags: { effects: true, icons: true } },
        { name: 'Russian Ursa', preview: 'Russian Ursa.png', file: 'Russian Ursa.zip', tags: { effects: true, icons: true } },
        { name: 'Scarlet Keeper', preview: 'Scarlet Keeper.png', file: 'Scarlet Keeper.zip', tags: { effects: true, icons: true } },
        { name: 'Shadow Fiend White', preview: 'Shadow Fiend White.png', file: 'Shadow Fiend White.zip', tags: { effects: true, icons: true } },
        { name: 'Shadow Shaman Purple', preview: 'Shadow Shaman Purple.png', file: 'Shadow Shaman Purple.zip', tags: { effects: true, icons: false } },
        { name: 'Spectre Toxin', preview: 'Spectre Toxin.png', file: 'Spectre Toxin.zip', tags: { effects: true, icons: true } },
        { name: 'Spirit Breaker Ghost Monster', preview: 'Spirit Breaker Ghost Monster.png', file: 'Spirit Breaker Ghost Monster.zip', tags: { effects: true, icons: true } },
        { name: 'Steel King', preview: 'Steel King.png', file: 'Steel King.zip', tags: { effects: true, icons: true } },
