...
const modsData = {
    ...
    'heroes': [
        { name: 'Alien Nyx Assassin', preview: 'Alien Nyx Assassin.png', file: 'Alien Nyx Assassin.zip', tags: { effects: true, items: true } },
        { name: 'Ancients Lina', preview: 'Ancients Lina.png', file: 'Ancients Lina.zip', tags: { effects: true, items: true } },
        { name: 'Arc Warden Black Hole', preview: 'Arc Warden Black Hole.png', file: 'Arc Warden Black Hole.zip', tags: { effects: true, items: true } },
        { name: 'Arc Warden Sakura Winter', preview: 'Arc Warden Sakura Winter.png', file: 'Arc Warden Sakura Winter.zip', tags: { effects: true, items: true } },
        { name: 'Ashes Arc Warden', preview: 'Ashes Arc Warden.png', file: 'Ashes Arc Warden.zip', tags: { effects: true, items: true } },
        { name: 'Axe Immortal Bootblack', preview: 'Axe Immortal Bootblack.png', file: 'Axe Immortal Bootblack.zip', tags: { effects: true, items: false } },
        { name: 'Bare Brewmaster 🥸', preview: 'Bare Brewmaster.png', file: 'Bare Brewmaster.zip', tags: { effects: false, items: false } },
        { name: 'Bloody Enigma', preview: 'Bloody Enigma.png', file: 'Bloody Enigma.zip', tags: { effects: true, items: true } },
        { name: 'Bloody Kez', preview: 'Bloody Kez.png', file: 'Bloody Kez.zip', tags: { effects: true, items: false } },
        { name: 'Brewmaster Jousting Panda', preview: 'Brewmaster Jousting Panda.png', file: 'Brewmaster Jousting Panda.zip', tags: { effects: false, items: false } },
        { name: 'Broodmother Redan', preview: 'Broodmother Redan.png', file: 'Broodmother Redan.zip', tags: { effects: true, items: true } },
        { name: 'Clinkz Silver Metall Pink', preview: 'Clinkz Silver Metall Pink.png', file: 'Clinkz Silver Metall Pink.zip', tags: { effects: true, items: true } },
        { name: 'Darkness Weaver', preview: 'Darkness Weaver.png', file: 'Darkness Weaver.zip', tags: { effects: true, items: true } },
        { name: 'Drow Ranger Stranger Arcana', preview: 'Drow Ranger Stranger Arcana.png', file: 'Drow Ranger Stranger Arcana.zip', tags: { effects: true, items: false } },
        { name: 'Earthshaker Red Arcana', preview: 'Earthshaker Red Arcana.png', file: 'Earthshaker Red Arcana.zip', tags: { effects: false, items: true } },
        { name: 'Ghost Fiend', preview: 'Ghost Fiend.png', file: 'Ghost Fiend.zip', tags: { effects: true, items: true } },
        { name: 'Ghosty Slark', preview: 'Ghosty Slark.png', file: 'Ghosty Slark.zip', tags: { effects: true, items: true } },
        { name: 'GopoPudge 🥰', preview: 'GopoPudge.png', file: 'GopoPudge.zip', tags: { effects: false, items: false } },
        { name: 'GopoTide 🥰', preview: 'GopoTide.png', file: 'GopoTide.zip', tags: { effects: false, items: false } },
        { name: 'Ice Phoenix', preview: 'Ice Phoenix.png', file: 'Ice Phoenix.zip', tags: { effects: true, items: true } },
        { name: 'Ice Venomancer', preview: 'Ice Venomancer.png', file: 'Ice Venomancer.zip', tags: { effects: true, items: true } },
        { name: 'IO Pink Arcana', preview: 'IO Pink Arcana.png', file: 'IO Pink Arcana.zip', tags: { effects: true, items: true } },
        { name: 'IO Purple', preview: 'Purple IO.png', file: 'IO Purple.zip', tags: { effects: true, items: true } },
        { name: 'Kai Meepo', preview: 'Kai Meepo.png', file: 'Kai Meepo.zip', tags: { effects: true, items: true } },
        { name: 'Legion Commander Crimson Black', preview: 'Legion Commander Crimson Black.png', file: 'Legion Commander Crimson Black.zip', tags: { effects: true, items: true } },
        { name: 'Lion Cannonroar Confessor', preview: 'Lion Cannonroar Confessor.png', file: 'Lion Cannonroar Confessor.zip', tags: { effects: true, items: true } },
        { name: 'Lion Dark Magician Girl', preview: 'Lion Dark Magician Girl.png', file: 'Lion Dark Magician Girl.zip', tags: { effects: true, items: true } },
        { name: 'Morphling Darktrench Stalker Purple', preview: 'Morphling Darktrench Stalker Purple.png', file: 'Morphling Darktrench Stalker Purple.zip', tags: { effects: true, items: true } },
        { name: 'Natures Prophet Allfather', preview: 'Natures Prophet Allfather.png', file: 'Natures Prophet Allfather.zip', tags: { effects: true, items: true } },
        { name: 'Nightmare Chaos Knight', preview: 'Nightmare Chaos Knight.png', file: 'Nightmare Chaos Knight.zip', tags: { effects: true, items: true } },
        { name: 'Ogre Magi Custom Arcana', preview: 'Ogre Magi Custom Arcana.png', file: 'Ogre Magi Custom Arcana.zip', tags: { effects: false, items: false } },
        { name: 'Old Storm Spirit', preview: 'Old Storm Spirit.png', file: 'Old Storm Spirit.zip', tags: { effects: true, items: true } },
        ...
        { name: 'Spectre Toxin', preview: 'Spectre Toxin.png', file: 'Spectre Toxin.zip', tags: { effects: true, items: true } },
        { name: 'Spirit Breaker Ghost Monster', preview: 'Spirit Breaker Ghost Monster.png', file: 'Spirit Breaker Ghost Monster.zip', tags: { effects: true, items: true } },
        { name: 'Steel King', preview: 'Steel King.png', file: 'Steel King.zip', tags: { effects: true, items: true } },
        { name: 'The Mawsworn Razor', preview: 'The Mawsworn Razor.png', file: 'The Mawsworn Razor.zip', tags: { effects: true, items: false } },
        { name: 'Ursa White and Red', preview: 'Ursa White and Red.png', file: 'Ursa White and Red.zip', tags: { effects: true, items: true } },
        { name: 'Warlock Puppet Bear', preview: 'Warlock Puppet Bear.png', file: 'Warlock Puppet Bear.zip', tags: { effects: true, items: false } },
        { name: 'Winter Ember Spirit', preview: 'Winter Ember Spirit.png', file: 'Winter Ember Spirit.zip', tags: { effects: true, items: true } }
    ],
    'roshan': [
