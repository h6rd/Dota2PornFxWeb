...
const categories = [
    ...
    { id: 'huds', emoji: '🎴', key: 'huds', preview: '', guideId: 'install' },
...
const addToCartRules = {
    hiddenCategories: ['guides', 'tools', 'huds'],
    allowedMods: {
...
const TAG_CONFIGS = {
    ...
    "hero-items": {
        allowForGuides: false,
        map: { totem: 'Totem', weapon: 'Weapon', mount: 'Mount', head: 'Head', arm: 'Arm', arms: 'Arms', armor: 'Armor', shoulders: 'Shoulders', back: 'Back', effects: 'Effects', icons: 'Icons', sounds: 'Sounds' }
    },
    tools: {
        allowForGuides: false,
...
function generateTagsHtml(mod, categoryId) {
    ...
    const SLOT_TAGS = ['totem', 'weapon', 'mount', 'head', 'arm', 'arms', 'armor', 'shoulders', 'back'];
